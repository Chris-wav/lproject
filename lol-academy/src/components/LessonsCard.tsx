...
const LessonsCard: React.FC<LessonsCardProps> = ({ lesson, index }) => {
  ...
  return (
    <div className="flex gap-2 p-4 bg-white rounded-[16px] mb-4 items-center w-[90vw]">
      <span
        className={`font-display ${numBg} ${numColor} p-5 rounded-[20px] text-2xl  shrink-0`}
      >
        {index + 1}
      </span>
      <div className=" ">
        ...
        <div className="flex justify-between items-center gap-4 mt-1">
          <p
            className={`${badgeBg} ${badgeColor} font-bold font-body px-2 py-1 rounded-[12px]  text-xs`}
          >
